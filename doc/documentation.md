...
- eu.wegest.statistiche.activity - contains activities representing screens
- eu.wegest.statistiche.fragment - contains fragments with main application logic
- eu.wegest.statistiche.listener - contains event listeners
- eu.wegest.statistiche.utility - contains utilities
- eu.wegest.statistiche.view - contains custom views and layouts
